...
class PurchaseOrder extends Model
{
    ...
    protected $fillable = ['tenant_id', 'number', 'supplier_id', 'project_id', 'client_id', 'created_by', 'status', 'order_date', 'expected_delivery_date', 'currency', 'subtotal', 'tax', 'total', 'lines', 'notes', 'shipping_address'];
