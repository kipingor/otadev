...
import { FolderOpen, Briefcase, Calendar, DollarSign, ArrowLeft, Save, Link2, Users } from 'lucide-react';
...
export default function ProjectCreate() {
    const { opportunities = [], clients = [], owners = [], statusOptions = [], currencyOptions = [] } =
        usePage<{ opportunities: Option[]; clients: Option[]; owners: Option[]; statusOptions: string[]; currencyOptions: string[] }>().props;
                ...
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Fill in the details below to create your project</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription>Project name, description and initial status</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="name">Project Name <span className="text-destructive">*</span></Label>
                                <Input id="name" placeholder="e.g. Website Redesign Q2" value={form.data.name}
                                    onChange={(e) => form.setData('name', e.target.value)} required autoFocus />
                                <InputError message={form.errors.name} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="description">Description</Label>
                                <Textarea id="description" placeholder="Describe the project scope, goals and deliverables…"
                                    rows={4} value={form.data.description ?? ''}
                    ...
                    <Card>
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription>Connect to an opportunity, client and assign a project owner</CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Select value={String(form.data.opportunity_id ?? '')}
                                    ...
                                    <SelectTrigger>
                                        <SelectValue placeholder="No linked opportunity" /></SelectTrigger>
                                    <SelectContent>                                        
                                        {opportunities.map((o) => (
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={String(form.data.client_id ?? '')}
                                    ...
                                    <SelectTrigger>
                                        <SelectValue placeholder="Unassigned" /></SelectTrigger>
                                    <SelectContent>
                                        {clients.map((c) => (
                    ...
                    <Card>
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription>Set project dates and financial targets</CardDescription>
                        </CardHeader>
